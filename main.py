...
button_mult = Button(root, text = "*", fg = "maroon4", bg = "CadetBlue1", command = lambda: key_press("*"), height = 1, width = 5)
button_mult.grid(row = 2, column = 4)

button_div = Button(root, text = "/", fg = "maroon4", bg = "CadetBlue1", command = lambda: key_press("/"), height = 1, width = 5)
